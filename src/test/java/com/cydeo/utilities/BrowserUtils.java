 ...
 */
    ...
    public static List<String> dropdownOptionsAsString(WebElement dropDownElement) {
        ...
        List<WebElement> optionsWebElements = select.getOptions();
        List<String> optionsText = new ArrayList<>();

        for (WebElement eachOptionWebElement : optionsWebElements) {
            String eachString = eachOptionWebElement.getText();

            optionsText.add(eachString);
        }
        return optionsText;
    }
